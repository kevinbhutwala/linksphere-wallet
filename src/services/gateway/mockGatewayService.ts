...
export const GATEWAY_PRODUCTS: GatewayProduct[] = [
  {
    ...
    title: 'Signature 450 GSM Heavyweight Hoodie',
    description: '100% combed organic cotton with high-density embroidered insignia and ribbed cuffs.',
  ...
  },
  {
    ...
    title: '750ml Vacuum-Insulated Thermal Flask',
    description: 'Pro-grade stainless steel with copper lining, temp retention lid, and matte finish.',
    priceFormatted: '$24.99',
    priceAmount: 24.99,
    currency: 'USD',
    category: 'PHYSICAL_GOODS',
    imageUri: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?auto=format&fit=crop&w=600&q=80',
    badge: 'LIFESTYLE ACCESSORY',
  },
  {
    id: 'pass_external_conf',
    sku: 'SKU_EXT_CONF_PASS_2026',
    title: 'Global Tech Summit 2026 Pass',
    description: 'All-access admission to keynote sessions, workshop lounges, and executive networking dinner.',
